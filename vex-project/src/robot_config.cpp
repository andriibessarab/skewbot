...
skewb_motor top_motor(TOP_MOTOR_PORT, 2.0, 0.0, 9.71); 
skewb_motor left_motor(LEFT_MOTOR_PORT, 1.95, 0.00, 9.5); 
skewb_motor right_motor(RIGHT_MOTOR_PORT, 1.90, 0.0, 10.0);
skewb_motor back_motor(BACK_MOTOR_PORT, 2.00, 0.0, 9.5);
