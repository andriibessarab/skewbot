    ...
    const draw = () => {
        ...
        if (ctx && canvas) {
            ...
            let CenterPoints: number[][] = [
                [start[0] + SkewbSize / 2, start[1] + SkewbSize / 2],
                [start[0] + CornerSideLength / 3, start[1] + CornerSideLength / 3],
                [start[0] + SkewbSize - CornerSideLength / 3, start[1] + CornerSideLength / 3],
                [
                    start[0] + SkewbSize - CornerSideLength / 3,
                    start[1] + SkewbSize - CornerSideLength / 3,
                ],
                [start[0] + CornerSideLength / 3, start[1] + SkewbSize - CornerSideLength / 3],
            ];
